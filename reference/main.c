/*
 * main.c, printing test vectors of reference implementation of the Kalyna
 * block cipher (DSTU 7624:2014), all block and key length variants.
 *
...
int main(int argc, char** argv) {
    ...
    uint64_t pt48_d[4];
    uint64_t key48_d[8] = {
        0x38393a3b3c3d3e3fULL, 0x3031323334353637ULL, 0x28292a2b2c2d2e2fULL, 0x2021222324252627ULL,
    ...
    uint64_t ct88_d[8] = {
        0x78797a7b7c7d7e7fULL, 0x7071727374757677ULL, 0x68696a6b6c6d6e6fULL, 0x6061626364656667ULL,
    ...
    uint64_t expect88_d[8] = {
        0x5252a025338480ceULL, 0x29d8a9e614d7ea1bULL, 0xbd45a8e90e1e38fdULL, 0xa346fad954450492ULL,
